...
class Medium
{
  public:
    ...
    virtual void ausgabe(std::ostream &o) const;
     ...
     *               false, wenn die Ausleihbeschr�nkungen nicht erf�llt sind und das Medium nicht ausgeliehen werden
     * kann
     */
     ...
     *
     * \return bool: gibt die status des Mediums zur�ck
     */
