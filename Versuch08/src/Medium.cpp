...
void Medium::ausgabe() const
{
    ...
    if (status)
    {
        std::cout << "Status : Das Medium ist seit dem " << datumAusgeliehen << " an " << personAusgeliehen.getName()
                  << " ausgeliehen." << std::endl;
    }
    else
    {
...
void Medium::ausgabe(std::ostream &o) const
{
    o << "ID: " << ID << std::endl;
    o << "Titel: " << titel << std::endl;

    if (status)
    {
        o << "Status : Das Medium ist seit dem " << datumAusgeliehen << " an " << personAusgeliehen.getName()
          << " ausgeliehen." << std::endl;
    }
    else
    {
        o << "Status: Medium ist zurzeit nicht verliehen." << std::endl;
    }
}
